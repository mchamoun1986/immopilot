...
export const TIPS_PAR_ETAPE: TipExpert[] = [
  ...
  { etape: 4, type: "astuce", titre: "Consultez le plan local d'urbanisme (PLU)", detail: "Avant toute offre, vérifiez le PLU de la commune sur geoportail-urbanisme.gouv.fr. Un terrain voisin classifié en zone constructible peut signifier une future construction qui déprécierait la vue ou l'ensoleillement.", source: "geoportail-urbanisme.gouv.fr" },
  ...
  { etape: 7, type: "economie", titre: "Compromis vs promesse : préférez le compromis", detail: "La promesse unilatérale engage uniquement l'acheteur. Le compromis de vente engage les deux parties — si le vendeur se retire, il peut être contraint à vendre. Préférez le compromis pour une meilleure protection.", source: "efficience.notaires.fr" },
