...
export const CONTACTS_PAR_ETAPE: ContactEtape[] = [
  ...
  { etape: 2, categorie: "comparateur", nom: "Empruntis", description: "Comparateur de credits immobiliers", url: "https://www.empruntis.com/", gratuit: true, affiliate_url: "https://www.empruntis.com/?ref=immopilot&subid={sessionId}" },
  ...
  // Etape 3
  { etape: 3, categorie: "professionnel", nom: "Votre banque", description: "Demandez un accord de principe ecrit", url: null, gratuit: true, affiliate_url: null },
  ...
  { etape: 3, categorie: "professionnel", nom: "Notaire (1er contact)", description: "Prenez contact tot — c'est gratuit et recommande", url: "https://www.notaires.fr/fr/annuaire-notaires", gratuit: true, affiliate_url: null },

  // Etape 4
  { etape: 4, categorie: "portail", nom: "SeLoger", description: "Portail d'annonces immobilieres", url: "https://www.seloger.com/", gratuit: true, affiliate_url: "https://www.seloger.com/?ref=immopilot&subid={sessionId}" },
  ...
  // Etape 5
  { etape: 5, categorie: "officiel", nom: "DVF Etalab", description: "Prix reels des transactions immobilieres", url: "https://app.dvf.etalab.gouv.fr/", gratuit: true, affiliate_url: null },
  { etape: 5, categorie: "professionnel", nom: "Diagnostiqueur certifie", description: "DPE, amiante, plomb, electricite, gaz", url: null, gratuit: false, affiliate_url: null },
  ...
  { etape: 5, categorie: "professionnel", nom: "Syndic de copropriete", description: "PV d'AG, charges, travaux votes", url: null, gratuit: true, affiliate_url: null },
  ...
  // Etape 7
  { etape: 7, categorie: "professionnel", nom: "Notaire acheteur", description: "Votre propre notaire — sans surcout", url: "https://www.notaires.fr/fr/annuaire-notaires", gratuit: true, affiliate_url: null },
  { etape: 7, categorie: "professionnel", nom: "Notaire vendeur", description: "Notaire designe par le vendeur", url: null, gratuit: true, affiliate_url: null },

  // Etape 8
  { etape: 8, categorie: "professionnel", nom: "Banques", description: "Deposez votre demande dans 3+ banques", url: null, gratuit: true, affiliate_url: null },
  { etape: 8, categorie: "comparateur", nom: "April", description: "Assurance emprunteur — delegation", url: "https://www.april.fr/", gratuit: false, affiliate_url: "https://www.april.fr/?ref=immopilot&subid={sessionId}" },
  ...
  { etape: 9, categorie: "professionnel", nom: "Banque", description: "Deblocage des fonds", url: null, gratuit: true, affiliate_url: null },
  ...
  { etape: 10, categorie: "officiel", nom: "Impots.gouv.fr", description: "Declaration d'occupation + taxe fonciere", url: "https://www.impots.gouv.fr/", gratuit: true, affiliate_url: null },
  { etape: 10, categorie: "officiel", nom: "ANTS", description: "Mise a jour carte grise", url: "https://ants.gouv.fr/", gratuit: true, affiliate_url: null },
